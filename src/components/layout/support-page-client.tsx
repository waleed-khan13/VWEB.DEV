...
import { LifeBuoy, ShieldCheck, Mouse } from "lucide-react";
...
export function SupportPageClient({ realm }: { realm: Realm }) {
  return (
    <div className="flex flex-col min-h-screen bg-gray-900 text-white">
      <Header />
      <main className="flex-grow">
        <SupportHero realm={realm} />
        <SupportContent realm={realm} />
      </main>
      <Footer />
    </div>
  );
